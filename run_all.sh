...
# Toda toolchain extra solicitada e validada antes da criacao do staging.
# Assim, um pedido impossivel falha cedo e nao deixa resultados centrais
# parciais apenas porque uma dependencia opcional explicitamente pedida falta.
...
# Isso evita que uma execucao abortada no meio (N muito grande, falha de
# benchmark/metadata/graficos/validacao) apareca como um out/<run_id>
# completo e indistinguivel de uma execucao valida.
