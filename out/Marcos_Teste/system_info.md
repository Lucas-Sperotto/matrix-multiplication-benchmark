...
_Gerado em: 2025-09-15 17:42:09_
...
- **CPUs lógicas (threads)**: 16
- **Threads por núcleo**: 2
- **CPU max MHz**: N/D
- **CPU min MHz**: N/D

### Memória (visão Linux dentro do WSL)
- **Memória total visível pelo WSL**: 7.63 GB

## Host Windows (via PowerShell)
- **Windows**: Windows 10 Pro 24H2
...
- **Lógicos (threads)**: 16
- **Clock Máx (MHz)**: 2300
- **Clock Atual (MHz)**: 2300

### Memória (host)
- **RAM física total**: 15,75 GB

### Status do WSL
```
Distribui��o Padr�o: docker-desktop
Vers�o Padr�o: 2
```
